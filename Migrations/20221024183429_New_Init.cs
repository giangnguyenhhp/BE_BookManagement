        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VNName = table.Column<string>(type: "text", nullable: false),
                    NameNXB = table.Column<string>(type: "text", nullable: false),
                    AuthorId = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CatalogsCatalogId = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookCatalog", x => new { x.BooksBookId, x.CatalogsCatalogId });
                    table.ForeignKey(
                        name: "FK_BookCatalog_Book_BooksBookId",
                        column: x => x.BooksBookId,
                        principalTable: "Book",
                        principalColumn: "BookId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookCatalog_Catalog_CatalogsCatalogId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookCatalog_CatalogsCatalogId",
                table: "BookCatalog",
